                        ...
                        if (simulationSpace == ParticleSystemSimulationSpace.World)
                        {
                            for (int j = 0; j < particleCount; j++)
                            {
                                ...
                                if (parameters.distanceToForceFieldCenterSqr < radiusSqr)
                                {
									...
									particleVelocity.x += xforce.x;
									particleVelocity.y += xforce.y;
									particleVelocity.z += xforce.z;
                                        ...
                                        case ParticleSystemSimulationSpace.Custom:
                                            {
                                                switch (scalingMode)
                                                {
                                                    case ParticleSystemScalingMode.Hierarchy:
                                                        {
													xforce = simulationSpaceTransform.InverseTransformVector(xforce);
													...
													xforce = Quaternion.Inverse(particleSystemRotation) * xforce;
													xforce = Vector3.Scale(xforce, new Vector3(
